...
"[project]/apps/admin/src/components/admin/MenuSectionsManagement.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const MenuSectionsManagement = ()=>{
    ...
    const [newItems, setNewItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MenuSectionsManagement.useEffect": ()=>{
            setSections((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$lib$2f$menu$2d$sections$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadMenuSections"])());
        }
    }["MenuSectionsManagement.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MenuSectionsManagement.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$lib$2f$menu$2d$sections$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveMenuSections"])(sections);
        }
    }["MenuSectionsManagement.useEffect"], [
        sections
    ]);
    const sectionIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MenuSectionsManagement.useMemo[sectionIds]": ()=>new Set(sections.map({
                "MenuSectionsManagement.useMemo[sectionIds]": (section)=>section.id
            }["MenuSectionsManagement.useMemo[sectionIds]"]))
    }["MenuSectionsManagement.useMemo[sectionIds]"], [
        sections
    ]);
    const filteredSections = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MenuSectionsManagement.useMemo[filteredSections]": ()=>{
            if (!searchQuery.trim()) {
                return sections;
            }
            const query = searchQuery.toLowerCase();
            return sections.filter({
                "MenuSectionsManagement.useMemo[filteredSections]": (section)=>section.id.toLowerCase().includes(query) || section.title.toLowerCase().includes(query) || section.items.some({
                        "MenuSectionsManagement.useMemo[filteredSections]": (item)=>item.id.toLowerCase().includes(query) || item.label.toLowerCase().includes(query)
                    }["MenuSectionsManagement.useMemo[filteredSections]"])
            }["MenuSectionsManagement.useMemo[filteredSections]"]);
        }
    }["MenuSectionsManagement.useMemo[filteredSections]"], [
    ...
    const handleAddItem = (sectionId)=>{
        var _newItems_sectionId;
        const draft = (_newItems_sectionId = newItems[sectionId]) !== null && _newItems_sectionId !== void 0 ? _newItems_sectionId : buildEmptyItem();
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: filteredSections.map((section)=>{
                    var _newItems_section_id;
                    const draftItem = (_newItems_section_id = newItems[section.id]) !== null && _newItems_section_id !== void 0 ? _newItems_section_id : buildEmptyItem();
...
_s(MenuSectionsManagement, "UiZfPYqii41FR2c0uXr58M6G7Yw=");
_c = MenuSectionsManagement;
var _c;
__turbopack_context__.k.register(_c, "MenuSectionsManagement");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/admin/src/app/admin/menu/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$components$2f$admin$2f$MenuSectionsManagement$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/admin/src/components/admin/MenuSectionsManagement.tsx [app-client] (ecmascript)");
"use client";
;
;
function MenuSectionsPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$components$2f$admin$2f$MenuSectionsManagement$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MenuSectionsManagement"], {}, void 0, false, {
                fileName: "[project]/apps/admin/src/app/admin/menu/page.tsx",
                lineNumber: 16,
                columnNumber: 7
            }, this)
...
_c = MenuSectionsPage;
var _c;
__turbopack_context__.k.register(_c, "MenuSectionsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_admin_src_7033554f._.js.map